  ...
  useEffect(() => {
    if (window.dataLayer && props.variantName) {
      window.dataLayer.push({
        ...
        component: 'AddressForm',
        variantIndex: props.variantIndex || 0,
        variantName: props.variantName || 'AddressForm1'
      });
    }
    ...
    const styleElement = document.createElement('style');
    styleElement.textContent = `
      .af1-hero-section .af1-hero-headline {
        color: #2e7d61;
        font-size: 2.2rem;
        font-weight: 700;
      }
      
      .af1-hero-section .af1-hero-subheadline {
        color: #444;
        font-size: 1.2rem;
        margin-bottom: 2rem;
      }
