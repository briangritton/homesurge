    ...
    try {
      ...
      if (propertyData) {
        ...
        updateFormData({
          ...
          // For HomeSurge, set values for potential increase and upgrades needed
          potentialValueIncrease: Math.round(propertyData.apiEstimatedValue * 0.15), // 15% of current value as example
          upgradesNeeded: Math.floor(Math.random() * 3) + 3 // Random between 3-5 upgrades
        });
    ...
    <div className="hero-section">
      <div className="hero-middle-container">
        <div className="hero-content fade-in">
          <div className="hero-headline">Get Your AI-Powered Home Value Boost Plan</div>
          <div className="hero-subheadline">Boost your home's value by up to 32% with our personalized AI recommendations</div>
