...
function HeroSection1FB(props) {
  ...
  useEffect(() => {
    ...
    if (windowViewCount <= 2) {
      window.dataLayer.push({
        event: "Hero1PageViewFB",
        title: "HeroSection1FB.js",
      });
  ...
  const [formHeadline, setFormHeadline] = useState(
    "Great! Please complete your contact registration to tell us where to send your cash offer details"
  );
    ...
    const possibleHeadlines = [
      ...
      },
      {
        ...
        phoneInvalidMessage:
          "Valid phone required to receive your cash offer details via text message (No Spam Ever)",
        formHeadline:
          "Great! Please complete your contact registration to tell us where to send your available cash refi details",
      ...
      },
      {
        ...
        phoneInvalidMessage:
          "Valid phone required to receive your cash amount details via text message (No Spam Ever)",
        formHeadline:
          "Great! Please complete your contact registration to tell us where to send your available cash details",
      ...
      },
      {
        ...
        phoneInvalidMessage:
          "Valid phone required to receive your cash offer details via text message (No Spam Ever)",
        formHeadline:
          "Great! Please complete your contact registration to tell us where to send your cash offer",
        thankYouHeadline: "Cash Offer Request Completed!",
        thankYouSubHeadline:
          "You'll be receiving your no obligation cash offer at your contact number shortly, thank you!",
      },
...

      {
        ...
        phoneInvalidMessage:
          "Valid phone required to receive your cash offer details via text message (No Spam Ever)",
        formHeadline:
          "Great! Please complete your contact registration to view your home value details",
      ...
      },
      {
        ...
        phoneInvalidMessage:
          "Valid phone required to receive your home value details via text message (No Spam Ever)",
        formHeadline:
          "Great! Please complete your contact registration to view your fast sell offer",
        thankYouHeadline: "Home Value Request Completed!",
        thankYouSubHeadline:
          "You'll be receiving your home value details at your contact number shortly, thank you!",
      },
  ...
  const formValidation = () => {
    if (props.formData.street.trim().length < 5) {
      streetRef.current.className = "hero-left-zip-field-container-1-invalid";
      return false;
    } else {
      return true;
    }
    ...
    <div className="hero-1-full-width-parent">
      <div className="HeroSection1">
        <div className="hero-1-middle-postioner">
          <div className="hero-middle-section-1">
      ...
      <div className="HeroSection1-below-fold">
        ...
        {/* FORM AGAIN */}
        <div className="hero-1-middle-form-postioner">
          <div className="hero-middle-form-container-1">
            {/* <div className="hero-left-zip-field-container-1">ZIP CODE</div> */}
            <input
              ref={streetRef}
