import "./FormMain.css";
import HeroSection1FB from "./HeroSection1FB";
import HeroSectionTYFB from "./HeroSectionTYFB";
...
function FormMainFB() {
  ...
  const stepDisplay = () => {
    ...
    if (formStep === 2) {
      ...
      if (window.fbq) {
        window.fbq("track", "CompleteRegistration"); // replace 'CompleteRegistration' with your event name
      }
